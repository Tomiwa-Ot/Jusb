...
JNIEXPORT jint JNICALL Java_com_grephq_ot_Jusb_getConfiguration(JNIEnv *, jclass) {

}

JNIEXPORT jstring JNICALL Java_com_grephq_ot_Jusb_getDescriptor(JNIEnv *, jclass) {
...
JNIEXPORT void JNICALL Java_com_grephq_ot_Jusb_setDebug(JNIEnv *, jclass, jint) {
